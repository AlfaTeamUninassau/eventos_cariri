...
class EventForm(forms.ModelForm):
    ...
    class Meta:
        model = Event
        fields = ['title', 'date', 'time', 'description', 'category', 'age_group', 'privacy', 'ticket_type', 'tickets', 'price', 'max_capacity', 'location']
        widgets = {
            ...
            'location': forms.Select(attrs={'class': 'w-full mt-1 p-2 border rounded'}),
        ...
        error_messages = {
            ...
            'price': {'max_digits': 'O preço não pode exceder R$9.999,00.'},
        }
